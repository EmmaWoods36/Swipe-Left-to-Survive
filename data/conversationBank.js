...
export const NPC_CONVERSATIONS = {
  ...
  val: [
    [
      ...
      {character:'val', speaker:{en:'Val',ja:'ヴァル'}, text:{en:'At least your taste in restaurants is improving. That\'s something.',ja:'少なくともレストランのセンスは上がってるね。それは何かだ。'}}
    ]
  ]
};
...
export const ANDREW_NAME_EXCHANGE = [
  ...
  {character:'andrew', revealsName:true, speaker:{en:'Andrew',ja:'アンドリュー'}, text:{en:'Andrew. I\'m Andrew. Sorry it took three meetings to say that.',ja:'アンドリュー。僕はアンドリュー。3回も会ってから言ってごめん。'}},
...
// James, Xavier and Christy are known people. Only Andrew has a name reveal.
export {pickKnownNpcConversation as pickStagedGreenFlagConversation} from './knownNpcConversations.js';
