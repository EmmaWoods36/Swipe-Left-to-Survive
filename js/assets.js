export const Asset = {
  backgrounds: {
    ...
    map: ['assets/backgrounds/city_map_day.png'],
    mapMorning: ['assets/backgrounds/city_map_day.png'],
    mapAfternoon: ['assets/backgrounds/city_map_afternoon.png'],
    mapEvening: ['assets/backgrounds/city_map_sunset.png'],
    mapDusk: ['assets/backgrounds/city_map_dusk.png'],
    mapNight: ['assets/backgrounds/city_map_night.png'],
